...
class __TwigTemplate_a72c2d58a6321df0e99eb252f5043eb0 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"container\">
      <div class=\"header-top-container\">
        ";
            // line 6
            $this->loadTemplate("@thex/template-parts/header/header-top-left.html.twig", "@ruhi/template-parts/header.html.twig", 6)->display($context);
            // line 7
            echo "        ";
            $this->loadTemplate("@thex/template-parts/header/header-top-right.html.twig", "@ruhi/template-parts/header.html.twig", 7)->display($context);
            // line 8
      ...
      ";
        ...
        ";
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "search_box", [], "any", false, false, true, 31)) {
                // line 32
                echo "          ";
                $this->loadTemplate("@thex/template-parts/header/search.html.twig", "@ruhi/template-parts/header.html.twig", 32)->display($context);
                // line 33
                echo "        ";
            }
            // line 34
...
";
        ...
        if ((($context["is_front"] ?? null) && ($context["slider_show"] ?? null))) {
            // line 40
            echo "  ";
            $this->loadTemplate("@ruhi/template-parts/slider.html.twig", "@ruhi/template-parts/header.html.twig", 40)->display($context);
        } elseif (( !        // line 41
($context["is_front"] ?? null) && twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "page_header", [], "any", false, false, true, 41))) {
            // line 42
            echo "  ";
            $this->loadTemplate("@thex/template-parts/header/header-page.html.twig", "@ruhi/template-parts/header.html.twig", 42)->display($context);
        }
        // line 44
        echo "</header>";
    }
    ...
    {
        return new Source("", "@ruhi/template-parts/header.html.twig", "D:\\xampp\\htdocs\\portfolio-drupal\\themes\\contrib\\ruhi\\templates\\template-parts\\header.html.twig");
    }

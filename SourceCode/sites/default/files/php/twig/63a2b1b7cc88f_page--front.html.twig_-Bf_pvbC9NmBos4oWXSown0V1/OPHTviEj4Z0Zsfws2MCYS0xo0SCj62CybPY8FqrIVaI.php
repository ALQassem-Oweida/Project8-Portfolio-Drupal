...
class __TwigTemplate_965bf2140e89a4fc13b9754fd468ccdb extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        $this->loadTemplate("@ruhi/template-parts/header.html.twig", "themes/contrib/ruhi/templates/layout/page--front.html.twig", 1)->display($context);
        // line 2
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "highlighted", [], "any", false, false, true, 2)) {
            // line 3
            echo "  ";
            $this->loadTemplate("@thex/template-parts/highlighted.html.twig", "themes/contrib/ruhi/templates/layout/page--front.html.twig", 3)->display($context);
        }
        // line 5
  ...
  ";
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "content_home_top", [], "any", false, false, true, 6)) {
            // line 7
            echo "    ";
            $this->loadTemplate("@thex/template-parts/content-parts/content_home_top.html.twig", "themes/contrib/ruhi/templates/layout/page--front.html.twig", 7)->display($context);
            // line 8
            echo "  ";
        }
        // line 9
    ...
    <div class=\"main-container\">
      ...
      ";
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "content_top", [], "any", false, false, true, 17)) {
            // line 18
            echo "          ";
            $this->loadTemplate("@thex/template-parts/content-parts/content_top.html.twig", "themes/contrib/ruhi/templates/layout/page--front.html.twig", 18)->display($context);
            // line 19
            echo "        ";
        }
        // line 20
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "content_bottom", [], "any", false, false, true, 23)) {
            // line 24
            echo "          ";
            $this->loadTemplate("@thex/template-parts/content-parts/content_bottom.html.twig", "themes/contrib/ruhi/templates/layout/page--front.html.twig", 24)->display($context);
            // line 25
            echo "        ";
        }
        // line 26
    ...
    ";
        ...
        if ((($context["front_sidebar"] ?? null) && twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "sidebar_first", [], "any", false, false, true, 27))) {
            // line 28
            echo "      ";
            $this->loadTemplate("@thex/template-parts/sidebar/sidebar_left.html.twig", "themes/contrib/ruhi/templates/layout/page--front.html.twig", 28)->display($context);
            // line 29
            echo "    ";
        }
        // line 30
        ...
        if ((($context["front_sidebar"] ?? null) && twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "sidebar_second", [], "any", false, false, true, 30))) {
            // line 31
            echo "      ";
            $this->loadTemplate("@thex/template-parts/sidebar/sidebar_right.html.twig", "themes/contrib/ruhi/templates/layout/page--front.html.twig", 31)->display($context);
            // line 32
            echo "    ";
        }
        // line 33
...
\t</div><!--/container -->
  ";
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "content_home_bottom", [], "any", false, false, true, 35)) {
            // line 36
            echo "    ";
            $this->loadTemplate("@thex/template-parts/content-parts/content_home_bottom.html.twig", "themes/contrib/ruhi/templates/layout/page--front.html.twig", 36)->display($context);
            // line 37
            echo "  ";
        }
        // line 38
...
";
        // line 39
        $this->loadTemplate("@ruhi/template-parts/footer.html.twig", "themes/contrib/ruhi/templates/layout/page--front.html.twig", 39)->display($context);
    }
    ...
    {
        return new Source("", "themes/contrib/ruhi/templates/layout/page--front.html.twig", "D:\\xampp\\htdocs\\portfolio-drupal\\themes\\contrib\\ruhi\\templates\\layout\\page--front.html.twig");
    }

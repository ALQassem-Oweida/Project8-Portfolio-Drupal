...
class __TwigTemplate_b90d5509e64e0fbb4d5ec542a2742352 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("ruhi/slider"), "html", null, true);
        echo "
    ...
    <div class=\"slider-text\">
      <ul class=\"js-rotating\">
        ...
        if ((($context["slider_code"] ?? null) != "")) {
            // line 8
            echo "          ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(twig_striptags($this->sandbox->ensureToStringAllowed(($context["slider_code"] ?? null), 8, $this->source), "<ol>,<ul>,<li>,<p>,<a>,<img>,<video>,<h1>,<h2>,<h3>,<h4>,<h5>,<h6>,<em>,<strong>,<br>,<i>,<button>,<mark>,<hr>"));
            echo "
        ";
        } else {
            // line 10
...
";
    ...
    {
        return new Source("", "@ruhi/template-parts/slider.html.twig", "D:\\xampp\\htdocs\\portfolio-drupal\\themes\\contrib\\ruhi\\templates\\template-parts\\slider.html.twig");
    }
